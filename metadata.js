...
// - Bagian 1: baca ID (tmdb.txt/mal.txt/group.txt) dan judul episode lokal (titles.txt) dari folder video
// - Bagian 2: fetch poster, judul show, dan judul episode dari TMDb / Jikan API
...
// (tmdb.txt, mal.txt, group.txt, titles.txt / titles_sX.txt)
// =====================================================================
...
const fetchTitles = async (filename, filePath) => {
    ...
    let episode = null;
    let forcedSeason = null; // BARU: Menangkap angka season dari file txt
...
// =====================================================================
// BAGIAN 2: FETCH DARI TMDb / JIKAN (poster, judul show, judul episode)
// =====================================================================
...
const fetchMetadata = async (tmdbID, malID, groupID, actualFilePath, cleanedName) => {
