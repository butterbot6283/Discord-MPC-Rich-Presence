  ...
  try {
    ...
    if (malID) {
      ...
      if (anime?.images?.jpg?.large_image_url) {
        return { poster: anime.images.jpg.large_image_url, showTitle: anime.title };
      }
    }
    ...
    if (imdbID && OMDB_API_KEY) {
      ...
      if (data?.Poster && data?.Poster !== "N/A") {
        ...
        return { poster: fixedPoster, showTitle: data.Title };
      }
    }
    ...
    if (config.autoPoster && title) {
      ...
      if (anime?.images?.jpg?.large_image_url) {
        return { poster: anime.images.jpg.large_image_url, showTitle: null };
      }
    }
